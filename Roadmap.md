...
- Navigazione principale: Inizia (home e tutorial) · Processi · Documenti · Integrazione · Intelligenza artificiale · Amministrazione. La scheda Tutorial scompare: i percorsi di apprendimento stanno sotto Inizia.
- Amministrazione unisce Menu Configurazione e Sistema. Connettori passano a Integrazione; dashboard e report alle Parti comuni.
...
- Integrazione e Intelligenza artificiale sono due schede separate: Integrazione (API standard, coda delle chiamate, SQL, fonti dati, script, acquisizione documenti, connettori) e Intelligenza artificiale.

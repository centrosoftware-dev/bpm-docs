...
Come nell'[allineamento del Designer di processo](../../modelli-di-processo/designer/barra-degli-strumenti.md#allineamento-e-dimensioni), la sezione **_Allineamento_** contiene gli strumenti per allineare gli elementi nel canvas del Magazzino delle variabili.

...
-   :material-sitemap-outline:{ .lg } **Processi**
    ...
    [:octicons-arrow-right-24: Modelli di processo](modelli-di-processo/index.md)

-   :material-file-document-multiple-outline:{ .lg } **Documenti**

    Tipi di documento con i loro metadati, archiviati e gestiti anche indipendentemente dai processi.

    [:octicons-arrow-right-24: Classi documentali](classi-documentali/index.md)

-   :material-connection:{ .lg } **Integrazioni**
...
-   :material-sitemap-outline:{ .lg } **Inizia con i processi**

    ---

    Disegna un flusso, definisci chi fa cosa e quali dati servono, pubblicalo e segui il processo che avanza nella To-Do List.

    [:octicons-arrow-right-24: Corso base](tutorial/corso-base/index.md)

-   :material-file-document-multiple-outline:{ .lg } **Inizia con i documenti**

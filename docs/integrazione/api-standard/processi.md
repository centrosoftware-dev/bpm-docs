...
Chiamate per avviare, leggere, modificare ed eliminare le istanze di processo, e per caricare allegati. Per le regole comuni (indirizzo, credenziali, identificazione dell'istanza, variabili) vedi [API standard](index.md).

...
Chiamate per leggere la To-Do List di un utente, eseguire un'attività e modificarne assegnazione, priorità e date. Per le regole comuni vedi [API standard](index.md).

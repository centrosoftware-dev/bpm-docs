...
![Creazione di un link](../../assets/modelli-di-processo/designer/activities/link-anim.gif)
...
![Menu del link](../../assets/modelli-di-processo/designer/activities/link-dropdown-screenshot.png)
...
Definisce una condizione, espressa tramite formula, che deve essere vera affinche il link venga percorso. E una forma compatta per gestire flussi condizionati, alternativa all'uso dei [Gateway](gateway.md).  
Quando è presente una condizione, compare un piccolo **rombo** grafico all'inizio del link.
Se da un elemento sono collegati piu **Link** con uscite diverse, vengono trattati come [percorsi liberi](gateway.md#percorsi-liberi-inclusive-e-complex). 

![Link condizionato](../../assets/modelli-di-processo/designer/activities/link-cond.png)
...
- Le [operazioni](operazioni/index.md) accettano un solo input e un solo output.

...
![Configurazione di utenti e responsabili](../../assets/modelli-di-processo/designer/menu/utenti-resp.png)
...
![Configurazione delle variabili da richiedere](../../assets/modelli-di-processo/designer/menu/inserimento-var.gif)
...
![Opzioni degli allegati](../../assets/modelli-di-processo/designer/menu/attachment-options.png)
...
Per crearne una e necessario cliccare la voce **Allegati** nella [barra degli strumenti](barra-degli-strumenti.md).  
...
![Configurazione delle operazioni](../../assets/modelli-di-processo/designer/menu/operazioni-config.png)
...
Le operazioni configurabili sono raccolte nella [sezione dedicata](../elementi/operazioni/index.md).
...
![Configurazione della pianificazione](../../assets/modelli-di-processo/designer/menu/pianificazione-1.png)
...
![Dati aggiuntivi della pianificazione](../../assets/modelli-di-processo/designer/menu/pianificazione-2.png)
...
![Configurazione dell'escalation](../../assets/modelli-di-processo/designer/menu/escalation.png)

**_Escalation/Timeout_** e una voce del menu contestuale esclusiva dell'oggetto [Attivita](../elementi/attivita.md).
...
![Icona dell'escalation](../../assets/modelli-di-processo/designer/menu/escalation-icon.png)
...
Utilizzando il menu contestuale su oggetti di tipo [Link](../elementi/link.md) si possono vedere altre opzioni specifiche per questo elemento:
...
Gli scopi di queste voci sono spiegati nella pagina dedicata ai [Link](../elementi/link.md).

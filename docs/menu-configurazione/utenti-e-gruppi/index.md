...
Il checkbox *Utilizza password policy*, se spuntato, applica le regole descritte nei [Parametri](../opzioni-generali/parametri.md#utilizza-password-policies-su-nuovi-utenti).

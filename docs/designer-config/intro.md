...
La sezione **_Designer e Configurazione_** del BPM è dedicata alla creazione, gestione e personalizzazione dei modelli di processo, delle classi documentali e delle variabili contenute al loro interno.
Da qui è possibile progettare in modo visuale i flussi di lavoro, definire le strutture dei documenti e configurare le impostazioni comuni che influenzano il comportamento del sistema.  

In questa parte dell’applicativo, l’utente ha pieno controllo sul **disegno logico dei processi**, traducendo in modo semplice ed intuitivo le logiche aziendali in automazioni concrete e coerenti con le esigenze operative.
...
- Le tipologie di strumenti disponibili  
...
- Le modalità di creazione e gestione delle classi documentali  
...
- Creare e gestire variabili di processo

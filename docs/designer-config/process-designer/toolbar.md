...
Qui sono presenti le principali azioni relative al processo, suddivise in 4 sezioni:

!["Toolbar - Home"](../../assets/designer-config/toolbar-home.png "Toolbar - Home")
...
!["Toolbar - Strumenti"](../../assets/designer-config/toolbar-strumenti.png "Toolbar - Strumenti")
...
Cliccando su questo pulsante ci si sposterà alla pagina del [Magazzino delle variabili](../variables/warehouse.md).
